...
class MonitoringBot:
    ...
    async def check_database(self) -> Dict[str, Any]:
        ...
        try:
            if not self.db_pool:
                return {"name": "PostgreSQL", "status": "down", "error": "No connection"}
    ...
    async def process_results(self, results: Dict[str, Any]):
        ...
        # Send alerts
        if alerts:
            message = f"⚠️ <b>АЛЕРТ - Sales Whisper Monitoring</b>\n\n" + "\n\n".join(alerts)
    ...
    async def get_status_report(self) -> str:
        ...
        report = f"📊 <b>Статус системы Sales Whisper</b>\n"
