...
class RateLimiter:
    ...
    async def is_allowed(
        ...
        try:
            ...
            # Безопасный режим по умолчанию: fail-closed.
            # Для аварийного обхода можно явно включить RATE_LIMIT_FAIL_OPEN=true.
...
__all__ = ["RateLimiter", "RateLimitConfig", "RateLimitMiddleware", "get_rate_limiter"]
