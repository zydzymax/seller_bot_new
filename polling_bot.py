...
class PollingBot:
    ...
    def __init__(self):
        ...
        self.running = True
        self.redis_client = redis.from_url(os.getenv('REDIS_ADDR', 'redis://localhost:6379/0'))
    ...
    async def process_update(self, update: dict):
        ...
        if chat_id and message_id:
            ...
            try:
                ...
                if not await self.redis_client.set(update_fingerprint, 1, nx=True, ex=60):
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if 'message' in update:
                        ...
                        logger.info(f"✅ Сообщение обработано webhook, ответ отправлен через FSM")
            ...
            try:
                ...
                for update in updates:
                    ...
                    if 'message' in update:
                        ...
                        logger.info(f"👤 От: {user.get('first_name', 'Unknown')} (@{user.get('username', 'no_username')})")
...
if __name__ == "__main__":
    ...
    if bot_mode != "polling":
        logger.warning(f"⚠️ PROD GUARD: BOT_MODE={bot_mode}, polling запрещен в production")
