    ...
    def _load_config(self) -> AudioConfig:
        ...
        try:
            ...
            tts_config = TTSConfig(
                ...
                model=tts_data.get("model", "gpt-4o-mini-tts"),
            ...
            processing_config = AudioProcessingConfig(
                ...
                cleanup_interval_hours=processing_data.get(
